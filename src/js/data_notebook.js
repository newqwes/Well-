...
mapFirstOptionSelect(BRAND_SELECTOR, NOTEBOOK_DATA);
mapProblemOptionSelect(PROBLEM_SELECTOR, PROBLEM_NOTEBOOK_DATA);
isChangeFirstOptionSelect(BRAND_SELECTOR, MODEL_SELECTOR, NOTEBOOK_DATA);
