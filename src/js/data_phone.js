...
const PROBLEM_SELECTOR = document.querySelector('#problem__phone');
...
const PHONE_DATA = [
  {id: '1', brand_db: 'Apple', model_db: [
    'iPhone 5s', 'MacBook Pro Retina (2012)','MacBook (2015)', 'Другое'
  ]},
...
BUTTON_PRICE_BG.addEventListener('click', () => { 
  ...
  MODAL_DESCRIPTION.innerHTML = 
    `${$('#brand__phone option:selected').html()} ${$('#model__phone option:selected').html()}. ${PROBLEM_SELECTOR.value}. Узнать стоимость?`;
  // Делаю как модалку
