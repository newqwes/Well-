const BUTTON = document.querySelector('#table-price__button_id')
...
BUTTON.addEventListener('click', () => {
    if (document.querySelector('#table-price__button_id').classList.contains("table-price__button_active")) {
        ...
        BUTTON.classList.remove('table-price__button_active')
    }
    else {
        HIDDEN_LIST.classList.remove('table-price__hidden')
        BUTTON.classList.add('table-price__button_active')
    }
})
